...
Examples:
  anonbird debug capture
  anonbird debug capture host 100.64.0.1 and port 443
  anonbird debug capture tcp
  anonbird debug capture icmp
  anonbird debug capture src host 10.0.0.1 and dst port 80
  anonbird debug capture -o capture.pcap
  anonbird debug capture --pcap | tshark -r -
  anonbird debug capture --pcap | tcpdump -r - -n`,
