...
var logoutCmd = &cobra.Command{
	...
	Short:   "Deregister from the AnonBird management service and delete this peer",
	Long:    "This command will deregister the current peer from the AnonBird management service and all associated configuration. Use with caution as this will remove the peer from the network.",
