...
var networksCMD = &cobra.Command{
	...
	Short:   "Manage connections to AnonBird networks and resources",
...
var routesListCmd = &cobra.Command{
	...
	Aliases: []string{"ls"},
	Short:   "List networks",
	Example: "  anonbird networks list",
...
var routesSelectCmd = &cobra.Command{
	...
	Example: "  anonbird networks select all\n  anonbird networks select route1 route2\n  anonbird routes select -a route3",
...
var routesDeselectCmd = &cobra.Command{
	...
	Example: "  anonbird networks deselect all\n  anonbird networks deselect route1 route2",
	Args:    cobra.MinimumNArgs(1),
