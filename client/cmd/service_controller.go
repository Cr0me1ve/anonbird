...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting AnonBird service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped AnonBird service") //nolint
	return nil
}
...
var runCmd = &cobra.Command{
	Use:   "run",
	Short: "runs AnonBird as service",
...
var startCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("AnonBird service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("AnonBird service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	Use:   "restart",
	Short: "restarts AnonBird service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel)
		if err != nil {
		...
		cmd.Println("AnonBird service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows AnonBird service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel)
		if err != nil {
		...
		cmd.Printf("AnonBird service status: %s\n", statusText)
		return nil
	},
}
