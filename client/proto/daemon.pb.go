...
type LoginRequest struct {
	...
	AnonymousMode                 *bool   `protobuf:"varint,41,opt,name=anonymous_mode,json=anonymousMode,proto3,oneof" json:"anonymous_mode,omitempty"`
	AnonymousTransport            *string `protobuf:"bytes,42,opt,name=anonymous_transport,json=anonymousTransport,proto3,oneof" json:"anonymous_transport,omitempty"`
	TorSocks5                     *string `protobuf:"bytes,43,opt,name=tor_socks5,json=torSocks5,proto3,oneof" json:"tor_socks5,omitempty"`
	I2PSam                        *string `protobuf:"bytes,44,opt,name=i2p_sam,json=i2pSam,proto3,oneof" json:"i2p_sam,omitempty"`
	I2PTunnelLength               *int32  `protobuf:"varint,45,opt,name=i2p_tunnel_length,json=i2pTunnelLength,proto3,oneof" json:"i2p_tunnel_length,omitempty"`
	I2PTunnelQuantity             *int32  `protobuf:"varint,46,opt,name=i2p_tunnel_quantity,json=i2pTunnelQuantity,proto3,oneof" json:"i2p_tunnel_quantity,omitempty"`
	I2PDaemonMode                 *string `protobuf:"bytes,47,opt,name=i2p_daemon_mode,json=i2pDaemonMode,proto3,oneof" json:"i2p_daemon_mode,omitempty"`
	I2PdPath                      *string `protobuf:"bytes,48,opt,name=i2pd_path,json=i2pdPath,proto3,oneof" json:"i2pd_path,omitempty"`
	I2PDataDir                    *string `protobuf:"bytes,49,opt,name=i2p_data_dir,json=i2pDataDir,proto3,oneof" json:"i2p_data_dir,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetAnonymousMode() bool {
	if x != nil && x.AnonymousMode != nil {
		return *x.AnonymousMode
	}
	return false
}

func (x *LoginRequest) GetAnonymousTransport() string {
	if x != nil && x.AnonymousTransport != nil {
		return *x.AnonymousTransport
	}
	return ""
}

func (x *LoginRequest) GetTorSocks5() string {
	if x != nil && x.TorSocks5 != nil {
		return *x.TorSocks5
	}
	return ""
}

func (x *LoginRequest) GetI2PSam() string {
	if x != nil && x.I2PSam != nil {
		return *x.I2PSam
	}
	return ""
}

func (x *LoginRequest) GetI2PTunnelLength() int32 {
	if x != nil && x.I2PTunnelLength != nil {
		return *x.I2PTunnelLength
	}
	return 0
}

func (x *LoginRequest) GetI2PTunnelQuantity() int32 {
	if x != nil && x.I2PTunnelQuantity != nil {
		return *x.I2PTunnelQuantity
	}
	return 0
}

func (x *LoginRequest) GetI2PDaemonMode() string {
	if x != nil && x.I2PDaemonMode != nil {
		return *x.I2PDaemonMode
	}
	return ""
}

func (x *LoginRequest) GetI2PdPath() string {
	if x != nil && x.I2PdPath != nil {
		return *x.I2PdPath
	}
	return ""
}

func (x *LoginRequest) GetI2PDataDir() string {
	if x != nil && x.I2PDataDir != nil {
		return *x.I2PDataDir
	}
	return ""
}
...
type GetConfigResponse struct {
	...
	AnonymousMode                 bool   `protobuf:"varint,28,opt,name=anonymous_mode,json=anonymousMode,proto3" json:"anonymous_mode,omitempty"`
	AnonymousTransport            string `protobuf:"bytes,29,opt,name=anonymous_transport,json=anonymousTransport,proto3" json:"anonymous_transport,omitempty"`
	TorSocks5                     string `protobuf:"bytes,30,opt,name=tor_socks5,json=torSocks5,proto3" json:"tor_socks5,omitempty"`
	I2PSam                        string `protobuf:"bytes,31,opt,name=i2p_sam,json=i2pSam,proto3" json:"i2p_sam,omitempty"`
	I2PTunnelLength               int32  `protobuf:"varint,32,opt,name=i2p_tunnel_length,json=i2pTunnelLength,proto3" json:"i2p_tunnel_length,omitempty"`
	I2PTunnelQuantity             int32  `protobuf:"varint,33,opt,name=i2p_tunnel_quantity,json=i2pTunnelQuantity,proto3" json:"i2p_tunnel_quantity,omitempty"`
	I2PDestination                string `protobuf:"bytes,34,opt,name=i2p_destination,json=i2pDestination,proto3" json:"i2p_destination,omitempty"`
	I2PDaemonMode                 string `protobuf:"bytes,35,opt,name=i2p_daemon_mode,json=i2pDaemonMode,proto3" json:"i2p_daemon_mode,omitempty"`
	I2PdPath                      string `protobuf:"bytes,36,opt,name=i2pd_path,json=i2pdPath,proto3" json:"i2pd_path,omitempty"`
	I2PDataDir                    string `protobuf:"bytes,37,opt,name=i2p_data_dir,json=i2pDataDir,proto3" json:"i2p_data_dir,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *GetConfigResponse) GetAnonymousMode() bool {
	if x != nil {
		return x.AnonymousMode
	}
	return false
...
func (x *GetConfigResponse) GetAnonymousTransport() string {
	if x != nil {
		return x.AnonymousTransport
	}
	return ""
...
func (x *GetConfigResponse) GetTorSocks5() string {
	if x != nil {
		return x.TorSocks5
	}
	return ""
...
func (x *GetConfigResponse) GetI2PSam() string {
	if x != nil {
		return x.I2PSam
	}
	return ""
...
func (x *GetConfigResponse) GetI2PTunnelLength() int32 {
	if x != nil {
		return x.I2PTunnelLength
	}
	return 0
...
func (x *GetConfigResponse) GetI2PTunnelQuantity() int32 {
	if x != nil {
		return x.I2PTunnelQuantity
	}
	return 0
...
func (x *GetConfigResponse) GetI2PDestination() string {
	if x != nil {
...
func (x *GetConfigResponse) GetI2PDaemonMode() string {
	if x != nil {
		return x.I2PDaemonMode
	}
	return ""
...
func (x *GetConfigResponse) GetI2PdPath() string {
	if x != nil {
		return x.I2PdPath
	}
	return ""
...
func (x *GetConfigResponse) GetI2PDataDir() string {
	if x != nil {
		return x.I2PDataDir
	}
	return ""
...
type SetConfigRequest struct {
	...
	AnonymousMode                 *bool                `protobuf:"varint,36,opt,name=anonymous_mode,json=anonymousMode,proto3,oneof" json:"anonymous_mode,omitempty"`
	AnonymousTransport            *string              `protobuf:"bytes,37,opt,name=anonymous_transport,json=anonymousTransport,proto3,oneof" json:"anonymous_transport,omitempty"`
	TorSocks5                     *string              `protobuf:"bytes,38,opt,name=tor_socks5,json=torSocks5,proto3,oneof" json:"tor_socks5,omitempty"`
	I2PSam                        *string              `protobuf:"bytes,39,opt,name=i2p_sam,json=i2pSam,proto3,oneof" json:"i2p_sam,omitempty"`
	I2PTunnelLength               *int32               `protobuf:"varint,40,opt,name=i2p_tunnel_length,json=i2pTunnelLength,proto3,oneof" json:"i2p_tunnel_length,omitempty"`
	I2PTunnelQuantity             *int32               `protobuf:"varint,41,opt,name=i2p_tunnel_quantity,json=i2pTunnelQuantity,proto3,oneof" json:"i2p_tunnel_quantity,omitempty"`
	I2PDaemonMode                 *string              `protobuf:"bytes,42,opt,name=i2p_daemon_mode,json=i2pDaemonMode,proto3,oneof" json:"i2p_daemon_mode,omitempty"`
	I2PdPath                      *string              `protobuf:"bytes,43,opt,name=i2pd_path,json=i2pdPath,proto3,oneof" json:"i2pd_path,omitempty"`
	I2PDataDir                    *string              `protobuf:"bytes,44,opt,name=i2p_data_dir,json=i2pDataDir,proto3,oneof" json:"i2p_data_dir,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *SetConfigRequest) GetAnonymousMode() bool {
	if x != nil && x.AnonymousMode != nil {
		return *x.AnonymousMode
	}
	return false
...
func (x *SetConfigRequest) GetAnonymousTransport() string {
	if x != nil && x.AnonymousTransport != nil {
		return *x.AnonymousTransport
	}
	return ""
...
func (x *SetConfigRequest) GetTorSocks5() string {
	if x != nil && x.TorSocks5 != nil {
		return *x.TorSocks5
	}
	return ""
...
func (x *SetConfigRequest) GetI2PSam() string {
	if x != nil && x.I2PSam != nil {
		return *x.I2PSam
	}
	return ""
...
func (x *SetConfigRequest) GetI2PTunnelLength() int32 {
	if x != nil && x.I2PTunnelLength != nil {
		return *x.I2PTunnelLength
	}
	return 0
...
func (x *SetConfigRequest) GetI2PTunnelQuantity() int32 {
	if x != nil && x.I2PTunnelQuantity != nil {
		return *x.I2PTunnelQuantity
	}
	return 0
...
func (x *SetConfigRequest) GetI2PDaemonMode() string {
	if x != nil && x.I2PDaemonMode != nil {
		return *x.I2PDaemonMode
	}
	return ""
...
func (x *SetConfigRequest) GetI2PdPath() string {
	if x != nil && x.I2PdPath != nil {
		return *x.I2PdPath
	}
	return ""
...
func (x *SetConfigRequest) GetI2PDataDir() string {
	if x != nil && x.I2PDataDir != nil {
		return *x.I2PDataDir
	}
	return ""
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x0eanonymous_mode\x18) \x01(\bH\x1cR\ranonymousMode\x88\x01\x01\x124\n" +
	"\x13anonymous_transport\x18* \x01(\tH\x1dR\x12anonymousTransport\x88\x01\x01\x12\"\n" +
	"\n" +
	"tor_socks5\x18+ \x01(\tH\x1eR\ttorSocks5\x88\x01\x01\x12\x1c\n" +
	"\ai2p_sam\x18, \x01(\tH\x1fR\x06i2pSam\x88\x01\x01\x12/\n" +
	"\x11i2p_tunnel_length\x18- \x01(\x05H R\x0fi2pTunnelLength\x88\x01\x01\x123\n" +
	"\x13i2p_tunnel_quantity\x18. \x01(\x05H!R\x11i2pTunnelQuantity\x88\x01\x01\x12+\n" +
	"\x0fi2p_daemon_mode\x18/ \x01(\tH\"R\ri2pDaemonMode\x88\x01\x01\x12 \n" +
	"\ti2pd_path\x180 \x01(\tH#R\bi2pdPath\x88\x01\x01\x12%\n" +
	"\fi2p_data_dir\x181 \x01(\tH$R\n" +
	"i2pDataDir\x88\x01\x01B\x13\n" +
	...
	"\r_disable_ipv6B\x11\n" +
	"\x0f_anonymous_modeB\x16\n" +
	"\x14_anonymous_transportB\r\n" +
	"\v_tor_socks5B\n" +
	"\n" +
	"\b_i2p_samB\x14\n" +
	"\x12_i2p_tunnel_lengthB\x16\n" +
	"\x14_i2p_tunnel_quantityB\x12\n" +
	"\x10_i2p_daemon_modeB\f\n" +
	"\n" +
	"_i2pd_pathB\x0f\n" +
	"\r_i2p_data_dir\"\xb5\x01\n" +
	"\rLoginResponse\x12$\n" +
	...
	"\busername\x18\x02 \x01(\tR\busername\"\xfa\v\n" +
	...
	"\x0eanonymous_mode\x18\x1c \x01(\bR\ranonymousMode\x12/\n" +
	"\x13anonymous_transport\x18\x1d \x01(\tR\x12anonymousTransport\x12\x1d\n" +
	"\n" +
	"tor_socks5\x18\x1e \x01(\tR\ttorSocks5\x12\x17\n" +
	"\ai2p_sam\x18\x1f \x01(\tR\x06i2pSam\x12*\n" +
	"\x11i2p_tunnel_length\x18  \x01(\x05R\x0fi2pTunnelLength\x12.\n" +
	"\x13i2p_tunnel_quantity\x18! \x01(\x05R\x11i2pTunnelQuantity\x12'\n" +
	"\x0fi2p_destination\x18\" \x01(\tR\x0ei2pDestination\x12&\n" +
	"\x0fi2p_daemon_mode\x18# \x01(\tR\ri2pDaemonMode\x12\x1b\n" +
	"\ti2pd_path\x18$ \x01(\tR\bi2pdPath\x12 \n" +
	"\fi2p_data_dir\x18% \x01(\tR\n" +
	"i2pDataDir\"\x92\x06\n" +
	"\tPeerState\x12\x0e\n" +
	...
	"\f_profileNameB\v\n" +
	"\t_username\"\x17\n" +
	"\x15SwitchProfileResponse\"\xbf\x15\n" +
	...
	"\x0eanonymous_mode\x18$ \x01(\bH\x19R\ranonymousMode\x88\x01\x01\x124\n" +
	"\x13anonymous_transport\x18% \x01(\tH\x1aR\x12anonymousTransport\x88\x01\x01\x12\"\n" +
	"\n" +
	"tor_socks5\x18& \x01(\tH\x1bR\ttorSocks5\x88\x01\x01\x12\x1c\n" +
	"\ai2p_sam\x18' \x01(\tH\x1cR\x06i2pSam\x88\x01\x01\x12/\n" +
	"\x11i2p_tunnel_length\x18( \x01(\x05H\x1dR\x0fi2pTunnelLength\x88\x01\x01\x123\n" +
	"\x13i2p_tunnel_quantity\x18) \x01(\x05H\x1eR\x11i2pTunnelQuantity\x88\x01\x01\x12+\n" +
	"\x0fi2p_daemon_mode\x18* \x01(\tH\x1fR\ri2pDaemonMode\x88\x01\x01\x12 \n" +
	"\ti2pd_path\x18+ \x01(\tH R\bi2pdPath\x88\x01\x01\x12%\n" +
	"\fi2p_data_dir\x18, \x01(\tH!R\n" +
	"i2pDataDir\x88\x01\x01B\x13\n" +
	"\x11_rosenpassEnabledB\x10\n" +
	"\x0e_interfaceNameB\x10\n" +
	"\x0e_wireguardPortB\x17\n" +
