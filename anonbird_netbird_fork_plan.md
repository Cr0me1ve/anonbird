...
- Оценка остатка на 2026-06-01 после open-source hygiene, GitHub/local rename, public repo switch, зелёного RC2 tag/release workflow, public GHCR manifests, clean one-command self-host из опубликованных образов и локального CI-hardening pass: примерно 96.8% от ТЗ закрыто; главный незакрытый блок — двухклиентная миграция NetBird->AnonBird, Tor-repeat/release-artifact Marton flow, повторный зелёный public-main CI после hardening и финальный release report.
