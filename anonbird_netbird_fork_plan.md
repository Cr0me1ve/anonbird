...
- Оценка остатка на 2026-06-01 после open-source hygiene, GitHub/local rename, public repo switch, зелёного RC2 tag/release workflow, public GHCR manifests и clean one-command self-host из опубликованных образов: примерно 96.5% от ТЗ закрыто; главный незакрытый блок — двухклиентная миграция NetBird->AnonBird, Tor-repeat/release-artifact Marton flow и финальный release report.
