...
- Оценка остатка на 2026-06-01 после open-source hygiene, GitHub/local rename, public repo switch, зелёного public `main` snapshot release workflow и anonymous-safe self-host quickstart hardening: примерно 94.5% от ТЗ закрыто; главный незакрытый блок — настоящий tag/release run, public GHCR manifests, clean one-command self-host из опубликованных образов, двухклиентная миграция NetBird->AnonBird и финальный release report.
