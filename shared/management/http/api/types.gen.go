...
type AccountExtraSettings struct {
	...
	// PeerManagementEndpoint Tor or I2P management endpoint used by generated peer setup commands. Dashboard API access can remain clearnet.
	PeerManagementEndpoint string `json:"peer_management_endpoint"`
